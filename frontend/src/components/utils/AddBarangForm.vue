    ...
    <div class="add-form-container">
      ...
      <form class="form-container" @submit.prevent="addtask">
        ...
        <div class="name-input">
          ...
          <input id="namabarang" type="text" v-model="title" />
        </div>


        <div class="name-input">
          <label for="deskripsi">Deskripsi</label>
          <input id="deskripsi" type="deskripsi" v-model="title" />
        </div>

        <div class="name-input">
          <label for="stok">Stok</label>
          <input id="stok" type="number" v-model="title" />
        </div>

        <div class="name-input">
          <label for="harga">harga</label>
          <input id="harga" type="harga" v-model="title" />
        </div>


        <div class="button-form">
          <button class="button-cencel" @click="closeAddModal">cencel</button>
